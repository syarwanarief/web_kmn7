...
class PengalamanNarasumber extends CI_Controller
{
    ...
    public function index()
    {
            ...
            $data['web'] = array(
                ...
                'aktif_menu' => 'profil',
                'page' => 'PengalamanNarasumber/view.php',
                'is_trview' => false,
                'is_table' => false,
            );
            $data['user'] = array(
            ...
            $data['tableks'] = $this->Query->getAllData('v_admin_pengalaman_narasumber')->result();

            $data['getlike2'] = $this->Query->RatingPN();
    ...
    public function Viewer()
    {
        ...
        if ($input_data['error']['message'] == null):
            ...
            redirect(base_url('PengalamanNarasumber/View/'.$id));
        else:
            redirect(base_url());
        endif;
