...
class KaryaTulis extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->status == 'OFF') {
            ...
            $data['tablekt'] = $this->Query->getAllData('v_admin_karya_tulis')->result();
            $data['getlike2'] = $this->Query->RatingKT();
    ...
    public function Viewer()
    {
        ...
        if ($input_data['error']['message'] == null):
            ...
            redirect(base_url('KaryaTulis/View/'.$id));
        else:
            redirect(base_url());
        endif;
