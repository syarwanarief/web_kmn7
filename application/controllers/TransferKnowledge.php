...
class TransferKnowledge extends CI_Controller
{
    ...
    public function index()
    {
            ...
            $data['web'] = array(
                ...
                'aktif_menu' => 'profil',
                'page' => 'TransferKnowledge/view.php',
                'is_trview' => false,
                'is_table' => false,
            );
            $data['user'] = array(
            ...
            $data['tabletk'] = $this->Query->getAllData('v_admin_transfer_knowledge')->result();

            $data['getlike2'] = $this->Query->RatingTK();
    ...
    public function Viewer()
    {
        ...
        if ($input_data['error']['message'] == null):
            ...
            redirect(base_url('TransferKnowledge/View/'.$id));
        else:
            redirect(base_url());
        endif;
