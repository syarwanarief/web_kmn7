<div class="content-wrapper">
	...
	<section class="content-header">
		<h4>
			UBAH DATA TENAGA KERJA PERKOMODITAS
		...
		<div class="box-body">
			<div class="col-md-6">
				<form action="<?php echo base_url('JumlahTK/filterEditTKkomoditas') ?>" method="get">
		...
		<div style="margin-left: 20px">
			<h3 class="card-header text-center font-weight-bold text-uppercase py-4">ubah data jumlah tenaga kerja
				...
				echo $thn[0];
				?></h3>
			<form action="<?php echo base_url('JumlahTK/SimpanPerubahanTKperKomoditas') ?>" method="post">
				...
				<div class="table-wrapper-scroll-y my-custom-scrollbar" style="overflow-x:auto;">
					<table class="table table-bordered table-striped mb-0" id="table">
						...
						foreach ($tampil
							...
							$id = $data->id;
							?>
							<form action="<?php echo base_url('JumlahTK/SimpanPerubahanTKperKomoditas') ?>"
								  method="post">
								<tr>
									...
									<td>
										...
										<input id="tidak_tetap" name="tidak_tetap" value="<?php echo $k_tidak_tetap ?>">
										</label>
									</td>
									<td>
