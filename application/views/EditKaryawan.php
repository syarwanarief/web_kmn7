    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('DataKaryawan/UpdateKaryawan') ?>">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control"  id="NOPEK2" placeholder="NOPEK"  value="<?php echo $data->nopek ?>" name="NOPEK2">
