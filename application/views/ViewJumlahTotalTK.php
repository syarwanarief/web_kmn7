            ...
            <form  action="<?php echo base_url('JumlahTK/tampil') ?>" method="get">
                <div class="input-group">
                    <select class="form-control" required="" id="ur" onChange="changeTextBox();" name="kat">
                        <option value="">--Pilih Tampilan Tahun--</option>
                        <?php foreach ($tampil as $data): ?>
                            <option value="<?php echo base64_encode($data->id_jumlah_total) ?>"><?php echo $data->tahun?></option>
                        <?php endforeach; ?>
                    </select>
        ...
        <div  class="box-body">
            <div class="panel panel-primary filterable">
                <div class="panel-heading">
                    <h3 class="panel-title">Jumlah Total Tenaga Kerja Pada Tahun <?php foreach ($tampil as $data): echo $data->tahun; endforeach; ?></h3>
                </div>
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-striped" border="2">
                        ...
                        ?>
                            <input type="hidden" name="pilihan" value="total">
                        <tr>
