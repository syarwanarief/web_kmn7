...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><font face="Book Antiqua">Reset Password</font></li>
        </ol>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Daftar Nama Pengguna</h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url('ResetPassword/detail/').base64_encode($data->nopek."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-primary">
                            ...
                            <a href="<?php echo base_url('ResetPassword/reset/').base64_encode($data->nopek."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-warning" onClick="return confirm('Reset Akun ?');">
                                <i class=" 	glyphicon glyphicon-refresh"></i>
                            </a>
                            <a href="<?php echo base_url('ResetPassword/delete/').base64_encode($data->nopek."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-danger" onClick="return confirm('Hapus Akun ?');">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('ResetPassword/edit/').base64_encode($data->nopek."-".base64_encode("PTPN7J@Y@")) ?>">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('ResetPassword/updateKontak/') ?>">
