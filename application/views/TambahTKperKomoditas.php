<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><font face="Book Antiqua">
				TAMBAH TENAGA KERJA PERKOMODITAS
			</font>
		</h1>
		<ol class="breadcrumb">
	...
	<section class="content">
		...
		<form action="<?php echo base_url('JumlahTK/SaveTkPerKomoditas') ?>" method="post">

			<div class="col-md-6">
				<div class="form-group">
					<label for="pil">Pilih Komoditas</label>
					<select class="form-control" id="pil" name="pil">
						<option value="">--Pilih Komoditas--</option>
						<?php foreach ($tampil
									   as $data): ?>
							<option value="<?php echo $data->komoditas ?>"><?php echo $data->komoditas ?></option>
						<?php endforeach; ?>
					</select>
				</div>
		...
		<script type="text/javascript">
            $(document).ready(function () {
                $('#pil').change(function () {
                    ...
                    $.ajax({
                        url: '<?php echo base_url();?>index.php/JumlahTK/loadPilihanKomoditas',
                        method: 'POST',
