...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><font face="Book Antiqua">Knowledge Sharing</font></li>
        </ol>
            ...
            <div class="box-body">
                ...
                <div class="panel panel-primary filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title">Knowledge Sharing</h3>
                ...
                <table id="example3" class="table table-bordered table-striped">
                    ...
                    foreach($getlike2 as $data):
                        ...
                        <tr>
                            ...
                            <td>  <a href="<?php echo base_url('KnowledgeSharing/Viewer/').base64_encode($data->id."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-primary">
                                    Lihat
                                </a>
                            </td>
                        ...
                        <table id="example" class="table table-striped">
                            ...
                            foreach($getlike2 as $data):
                                ...
                                <tr >
                                    ...
                                    <td><?php echo $data->judul ?></td>
                                    <td><?php echo $data->suka ?></td>
                                    <td>  <a href="<?php echo base_url('KnowledgeSharing/View/').base64_encode($data->id."-".base64_encode("PTPN7J@Y@"))?>" class="btn btn-xs btn-primary">
                                            Lihat
                                        </a>
                                    </td>
        ...
        <div class="modal fade" id="topreview" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">TOP 10 KOMENTAR</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <table id="example4" class="table table-striped">
                            ...
                            foreach($getlike2 as $data3):
                                ...
                                <tr >
                                    ...
                                    <td><?php echo $data3->JumlahKomen ?></td>
                                    <td>  <a href="<?php echo base_url('KnowledgeSharing/View/').base64_encode($data->id."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-primary">
                                            Lihat
                                        </a>
                                    </td>
