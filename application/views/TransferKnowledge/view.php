...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><font face="Book Antiqua">Transfer Knowledge</font></li>
        </ol>
            ...
            <div class="box-body">
                <div class="panel panel-primary filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title">Transfer Knowledge</h3>
                    ...
                    foreach($getlike2 as $data):
                        ...
                        <tr>
                            ...
                            <td>  <a href="<?php echo base_url('TransferKnowledge/Viewer/').base64_encode($data->id."-".base64_encode("PTPN7J@Y@")) ?>" class="btn btn-xs btn-primary">
                                    Lihat
                                </a>
                            </td>
                    ...
                    <div class="modal-body">
                        ...
                        <table id="example" class="table table-striped">
                            ...
                            <tr >
                                ...
                                <td><?php echo $data->judul ?></td>
                                <td><?php echo $data->suka ?></td>
                                <td>  <a href="<?php echo base_url('TransferKnowledge/View/').base64_encode($data->id."-".base64_encode("PTPN7J@Y@"))?>" class="btn btn-xs btn-primary">
                                        Lihat
                                    </a>
                                </td>
