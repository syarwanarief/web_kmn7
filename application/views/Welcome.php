                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/Nanda.png')?>" alt="card image"></p>
                                    <h4 class="card-title">Nanda Primalita</h4>
                                    <p class="card-text">Prodi Agroekoteknologi Fakultas Pertanian Universitas Sriwijaya</p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Nanda Primalita</h4>
                                    <p class="card-text">Bersyukur bisa jadi bagian dari Program Magang BUMN Bersertifikat. Bertemu dengan orang-orang hebat di PTPN 7 merupakan hal emas yg gak semua orang bisa mengalaminya. Terimakasih dan maaf keluarga baru ku, PTPN 7. Sehat dan sukses selalu. Jangan lupa bersyukur.</p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/syuef.png')?>" alt="card image"></p>
                                    <h4 class="card-title">Amri Suef</h4>
                                    <p class="card-text">Prodi Budidaya Tanaman Perkebunan D3 Politeknik LPP Yogyakarta</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Amri Suef</h4>
                                    <p class="card-text">"Jangan percaya dengan kata² bijak, Kamu cukup bangkit dari tidur mu untuk bekerja dan belajar lebih keras".</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/saputro.png')?>" alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Andri Saputro</h4>
                                    <p class="card-text">Setiap Rasa Bisa Dinikmati. Tak Peduli Apapun Itu Rasanya. Maka Nikmatilah Selagi Masih Sempat. <br/><br/>By: saputro.a.97</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/igo.png')?>" alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    ...
                                    <p class="card-text">Hidup di dunia ini keras, maka jangan menjadi orang yang lemah.  Hidup hanya sekali lakukanlah yang terbaik dan buat bahagia semua orang.</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/imam.png')?>" alt="card image"></p>
                                    <h4 class="card-title">Imam Hidayah</h4>
                                    <p class="card-text">Program Studi Informatika Fakultas Ilmu Komputer Universitas Bandar Lampung</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/handoko.png')?>" alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Andri Handoko</h4>
                                    <p class="card-text">Kita tak bisa kembali ke masa lalu dan mengubah sebuah awal yg buruk. Namun kita bisa membuat akhir yang indah, mulai saat ini...</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/jorgi.png')?>" alt="card image"></p>
                                    <h4 class="card-title">Jorgi Adriyanto</h4>
                                    <p class="card-text">Prodi Teknik Sipil Fakultas Teknik Universitas Bandar Lampung</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Jorgi Adriyanto</h4>
                                    <p class="card-text">"cara terbaik memprediksi masa depan adalah mengambil tindakan pada saat ini"</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/riyan.png')?>" alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Riyan Syahputra</h4>
                                    <p class="card-text">Jadilah engkau seperti Intan.  Dimanapun ia diletakkan akan tetap menjadi intan,  tidak akan pernah jadi permata..</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo base_url('assets/images/ahmad.png')?>" alt="card image"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Ahmad Sepriansyah</h4>
                                    <p class="card-text">Jangan karena kita lebih intelektual, dan dengan mudahnya memandang seseorang itu bodoh, itu adalah salah satu sifat yg seharusnya tidak dimiliki orang yg sudah sukses.</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
